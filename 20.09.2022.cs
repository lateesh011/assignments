...
select * from issue
where return_date > getdate() or return_date is null 
...
update issue set return_date = '31-Dec-06' where return_date is null
and lib_issue_id!= 7005 and lib_issue_id!= 7006
